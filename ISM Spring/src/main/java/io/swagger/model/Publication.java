...
public class Publication   {
  public Publication(Long id, String title, String author, Integer releaseYear, @Valid List<Genre> genre, OffsetDateTime dateAdded) {
    this.id = id;
    this.title = title;
    this.author = author;
  ...
  public Publication photoUrls(List<String> photoUrls) {
    this.photoUrls = photoUrls;
    return this;
  }

  public Publication addPhotoUrlsItem(String photoUrlsItem) {
