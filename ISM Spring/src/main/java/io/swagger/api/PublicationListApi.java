...
public interface PublicationListApi {
    ...
    ResponseEntity<List<PublicationList>> findPublicationsListByUserId(@NotNull @Parameter(in = ParameterIn.QUERY, description = "User id to filter by" ,required=true,schema=@Schema()) @Valid @RequestParam(value = "userId", required = true) Long userId);
