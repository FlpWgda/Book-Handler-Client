...
public interface UserApi {
    ...
    ResponseEntity<Void> createUser(@Parameter(in = ParameterIn.DEFAULT, description = "Creates user object", required=true, schema=@Schema()) @Valid @RequestBody User body);
    ...
    ResponseEntity<Void> deleteUser(@Parameter(in = ParameterIn.PATH, description = "The name that needs to be deleted", required=true, schema=@Schema()) @PathVariable("username") String username, @Parameter(in = ParameterIn.COOKIE, description = "The user role" ,required=true,schema=@Schema(allowableValues={ "admin", "member" }
    ...
    ResponseEntity<Void> updateUser(@Parameter(in = ParameterIn.PATH, description = "Name that needs to be updated", required=true, schema=@Schema()) @PathVariable("username") String username, @Parameter(in = ParameterIn.DEFAULT, description = "Updated user object", required=true, schema=@Schema()) @Valid @RequestBody User body);
